        ...
        <div className="mx-auto max-w-4xl lg:max-w-[960px] flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 min-w-0 text-center lg:text-left">
            ...
            <h2 className="mt-2.5 font-display text-2xl sm:text-3xl lg:text-4xl font-bold leading-[1.2] text-[#2b1719]">
              {data.heading || "A little taste of home, made with a whole lot of love."}
            </h2>

            <p className="mt-4 text-xs sm:text-sm lg:text-base leading-relaxed text-[#5a4843] max-w-xl mx-auto lg:mx-0">
              {data.description || "Namma Ada is a Bangalore-based Kerala delicacy brand inspired by recipes passed down through generations. We bring Kerala's timeless taste to your table through fresh, handcrafted delicacies made with authentic flavours and a whole lot of love."}
            </p>
