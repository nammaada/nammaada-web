      ...
      <header
        className={
          isHome
            ...
            : "sticky top-0 z-40 border-b border-[#e5d8c6] bg-[#fbf7ef]/95 backdrop-blur-md"
        }
      >
        <Container className={isHome ? "py-3 sm:py-4" : "py-2 sm:py-3"}>
          <div
            className={`flex min-h-14 sm:min-h-16 items-center justify-between gap-3 sm:gap-4 rounded-full border px-3.5 sm:px-6 ${
              isHome
                ? "border-white/80 bg-[#fffdf8]/75 shadow-sm backdrop-blur-md"
                : "border-[#e5d8c6] bg-[#fffdf8] shadow-soft"
            }`}
          >
            {/* LOGO */}
            <Link
                ...
                return (
                  <Link
                    className={`relative py-2 text-sm font-semibold transition-colors focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ring ${
                      active
                        ? "text-[#4a0e17]"
                        : "text-[#2b1719]/75 hover:text-[#4a0e17]"
                    }`}
                    href={route.href}
                    key={route.href}
                  ...
                  >
                    {route.label}
                    {active && (
                      <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 h-[2.5px] w-5 rounded-full bg-[#4a0e17]" />
                    )}
                  </Link>
                );
              })}
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Link
                ...
                className="inline-flex min-h-11 min-w-11 items-center justify-center gap-2 rounded-full border border-[#e5d8c6] bg-[#fffdf8] px-3.5 text-xs sm:text-sm font-semibold text-[#4a0e17] shadow-xs transition-all hover:bg-[#f4efeb] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring active:scale-95"
                href="/cart"
                onClick={closeMenu}
              >
              ...
              <Link
                className="hidden min-h-11 items-center justify-center rounded-full bg-[#4a0e17] px-5 sm:px-6 text-xs sm:text-sm font-semibold text-white shadow-xs transition-all duration-200 hover:bg-[#380a11] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring active:scale-95 lg:inline-flex"
                href="/products"
              >
                Order Now
              </Link>
              ...
              <button
                ...
                className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-full border border-[#e5d8c6] bg-[#fffdf8] text-[#4a0e17] transition-colors hover:bg-[#f4efeb] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring lg:hidden active:scale-95"
          ...
          <div className="border-b border-[#e5d8c6] bg-[#fffdf8] py-3.5">
            <Container className="flex items-center justify-between">
              ...
              <button
                ...
                className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-full border border-[#e5d8c6] bg-[#f4efeb] text-[#4a0e17]"
                onClick={closeMenu}
                type="button"
              >
                <X size={20} />
          ...
          <div className="flex-1 overflow-y-auto py-6">
            <Container className="flex flex-col h-full justify-between gap-8">
              ...
              <div className="pt-4 border-t border-[#e5d8c6] space-y-3">
                <Link
                  className="flex min-h-12 w-full items-center justify-center rounded-full bg-[#4a0e17] px-6 text-sm font-semibold text-white shadow-md active:scale-98"
                  href="/products"
                  onClick={closeMenu}
                >
                  Order Now
