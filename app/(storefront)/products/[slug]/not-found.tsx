    ...
    <main className="section-shell flex min-h-[65vh] items-center">
      <div className="site-container">
        <section className="mx-auto max-w-xl rounded-2xl border border-border bg-card px-6 py-12 text-center shadow-soft sm:px-10">
          ...
          <Link className="mt-7 inline-flex min-h-11 items-center rounded-full bg-primary px-5 text-sm font-semibold text-primary-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring" href="/products">Browse products</Link>
        </section>
      </div>
    </main>
  );
